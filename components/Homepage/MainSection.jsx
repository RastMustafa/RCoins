    ...
    <div className="  font-header  grid grid-cols-12 pt-8 sm:pt-12 bg-opacity-80	   container mx-auto  py-5">
      <div className=" col-span-12   md:col-span-6 sm:pl-4 pl-12  flex flex-col px-4    w-full">
        ...
        <div className="mt-4 sm:mx-12 font-display">
          <button className="border-2 text-[12px] sm:text-lg border-emerald-800 md:font-bold hover:text-white transition-all duration-500 hover:bg-black rounded shadow-xl px-2.5 py-1 md:px-3 md:py-1 lg:px-6 lg:py-1.5 font-semibold">
            Trade Now
          </button>
        </div>
      </div>
