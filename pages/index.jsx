...
export default function Home() {
  return (
    <div className="bg-gray-0">
      <div className="  bg-layer1 bg-cover spacer">
        <Navbar />
        <MainSection />
      </div>
      ...
      <div className=" relative md:pb-[14rem] 2xl:h-[40rem] bg-layer2 spacer lg:mt-12 mt-24  px-2  md:px-5 mx-0   w-full  ">
        <Suspense fallback={`Loading...`}>
          <Chart />
        </Suspense>
      </div>

      <div className="   bg-layer3 bg-cover lg:pt-0 pt-36  spacer  px-5 mx-0   w-full">
      ...
      <div className="mt-[8rem] relative bg-layer4 spacer  w-full ">
        <TradeFreeAction />
      </div>
